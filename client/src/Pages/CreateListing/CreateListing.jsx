...
export default function CreateListing() {
    ...
    const handleImageSubmit = (e) => {
        ...
        .catch((err)  => {
            setImageUploadError('Image upload failed (2 Mb max per image)',err.message);
            setUploading(false);
        });
    }
    else{
  ...
  return (
    <main className="p-3 max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col  sm:flex-row gap-6 mb-5">
                    ...
                    formData.imageUrls.length > 0 && formData.imageUrls.map((url,index) =>(
                        <div key={url} className="flex justify-between p-3 border items-center rounded-xl">
                            ...
                            <button 
                                ...
                                className="p-3 text-red-500 rounded-lg uppercase hover:opacity-60"
                            >
                                Delete
                            </button>
